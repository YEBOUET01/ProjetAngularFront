  ...
  export class AssignmentsService {
    ...
    backendUrl = 'https://projetangularback.onrender.com/api/assignments';
    ...
    peuplerBDavecForkJoin():Observable<any> {
      ...
      bdInitialAssignments.forEach(a => {
        ...
        nouvelAssignment.dateDeRendu = new Date('');
    ...
    viderBD(): Observable<any> {
      return this.http.delete<any>(this.backendUrl);
    }
